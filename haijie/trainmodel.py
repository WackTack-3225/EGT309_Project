...
def train():
    ...
    freeze_top_layers = int(request.form['freeze_top_layers'])
    freeze_bottom_layers = int(request.form['freeze_bottom_layers'])
    ...
    try:
        ...
        for layer in transfer_model.layers[:freeze_top_layers]:
            layer.trainable = False
        for layer in transfer_model.layers[freeze_bottom_layers:]:
        ...
        transfer_model.compile(
            ...
            optimizer=Adam(learning_rate),  # Lower learning rate
            metrics=['accuracy']
        )
